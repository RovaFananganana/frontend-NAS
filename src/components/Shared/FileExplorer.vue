<template>
  ...
  >
    ...
    <SelectionIndicator
      ...
      :show-progress="selectedCount > 1"
      :show-shortcuts="selectedCount === 1"
    ...
    >
      ...
      >
        ...
        <button 
          ...
          aria-label="Réessayer le chargement des fichiers"
        >
  ...
  <ContextMenu
    ...
    :show-permission-errors="showPermissionErrors"
    @open="openContextItem"
    @download="downloadContextFile"
...
.file-explorer-content {
  flex: 1;
  min-height: 0; /* Important pour le scroll dans les enfants */
  display: flex;
  flex-direction: column;
}
